...
- **Designing Data Applications**- Knowledge of how to design and build a 'full-stack' data application.
- **User-facing Web design concepts** - Proficiency in creating user-facing interfaces to communicate data.
